  ...
  return (
    <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white pb-20 pt-32 lg:pt-40 px-6 rounded-b-[3rem] lg:rounded-b-[5rem] overflow-hidden shadow-2xl">
      <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] left-[-10%] w-96 h-96 bg-teal-500 rounded-full blur-[100px]"></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10 relative z-10">
        <div className="flex-shrink-0">
          <div className="relative group">
            ...
            <img 
              src="https://niftytechfinds.com/wp-content/uploads/2025/12/1655804635107_processed.webp" 
              alt={PROFILE.name} 
        ...
        <div className="flex-1 text-center md:text-left space-y-6">
          <div>
            ...
            <p className="text-xl md:text-2xl text-blue-200 mt-2 font-medium max-w-2xl">
              {PROFILE.tagline}
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm md:text-base text-slate-300">
             ...
             <a href={`mailto:${PROFILE.email}`} className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm hover:bg-white/20 transition-colors">
